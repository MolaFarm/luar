...
use crate::lualib::baselib::{lua_print,lua_type};
use crate::lualib::auxlib::{ipairs,test_new_counter};
...
impl ExeState {
    pub fn new() -> Self {
        ...
        env.map.insert("print".into(), Value::RustFunction(lua_print));
        env.map.insert("type".into(), Value::RustFunction(lua_type));
